...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/adk))
...
**Important:** This dependency configuration *replaces* the JVM dependency.
...
**Warning:** Do not embed API keys in client apps or include your API key
in a published application. For production use cases, call cloud models through
your own backend service or through [Firebase AI Logic](https://firebase.google.com/docs/ai-logic) so that API keys are
...
[Gemini Nano](/ai/gemini-nano) through ML Kit GenAI API. This approach allows agents to run
