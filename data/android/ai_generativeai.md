...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/generativeai))
...
applications using the [Firebase AI Logic SDK](/ai/vertex-ai-firebase). This SDK is designed for
...
* **E) Need advanced content classification, sentiment analysis, or
  ...
  + **→ Use: Cloud-based solutions (e.g.,** [**Google Cloud Natural Language
    ...
    [Vertex AI](https://cloud.google.com/vertex-ai))**. (Lower priority than on-device options if offline or
    privacy is key).
...
* **A) Need a balance of performance and cost, suitable for general text
  ...
  + **→ Use: [Firebase AI Logic SDK with Gemini Flash](/ai/vertex-ai-firebase)**
  + *Why*: Optimized for speed and
    efficiency within the Vertex AI managed environment.
* **B) Need higher quality and capability for complex text generation,
  reasoning, advanced NLU, or instruction following?**
  + **→ Use: [Firebase AI Logic SDK with Gemini Pro](/ai/vertex-ai-firebase)**
