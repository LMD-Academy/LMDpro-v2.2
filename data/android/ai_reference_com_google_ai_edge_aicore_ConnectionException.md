...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/reference/com/google/ai/edge/aicore/ConnectionException))

---

[Kotlin](/ai/reference/kotlin/com/google/ai/edge/aicore/ConnectionException "View this page in Kotlin")
|Java

```
public final class ConnectionException extends GenerativeAIException
```
...
|  |  |  | ↳ | [com.google.ai.edge.aicore.ConnectionException](/ai/reference/com/google/ai/edge/aicore/ConnectionException) |
