...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/reference/com/google/ai/edge/aicore/InferenceException))

---

[Kotlin](/ai/reference/kotlin/com/google/ai/edge/aicore/InferenceException "View this page in Kotlin")
|Java

```
public final class InferenceException extends GenerativeAIException
```
...
|  |  |  | ↳ | [com.google.ai.edge.aicore.InferenceException](/ai/reference/com/google/ai/edge/aicore/InferenceException) |
