...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/reference/com/google/ai/edge/aicore/TokenizationException))

---

[Kotlin](/ai/reference/kotlin/com/google/ai/edge/aicore/TokenizationException "View this page in Kotlin")
|Java

```
public final class TokenizationException extends GenerativeAIException
```
...
|  |  |  | ↳ | [com.google.ai.edge.aicore.TokenizationException](/ai/reference/com/google/ai/edge/aicore/TokenizationException) |
