...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/reference/com/google/ai/edge/aicore/UnknownException))

---

[Kotlin](/ai/reference/kotlin/com/google/ai/edge/aicore/UnknownException "View this page in Kotlin")
|Java

```
public final class UnknownException extends GenerativeAIException
```
...
|  |  |  | ↳ | [com.google.ai.edge.aicore.UnknownException](/ai/reference/com/google/ai/edge/aicore/UnknownException) |
