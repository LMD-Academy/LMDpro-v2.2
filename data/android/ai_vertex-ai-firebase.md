...
[//]: # (source: [developer.android.com](https://developer.android.com/ai/vertex-ai-firebase))

If you're new to the Gemini API, the [Gemini Developer API](/ai/gemini/developer-api) is the
...
[Interact with the Gemini Developer API from your app](/ai/gemini/developer-api#interact-gemini).
