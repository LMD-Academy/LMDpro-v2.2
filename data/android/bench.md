...
[//]: # (source: [developer.android.com](https://developer.android.com/bench))

![Hero Image](https://developer.android.com/static/images/bench/hero.png)
...
View [**archived leaderboards**](/bench/archive) and check back periodically for updates.

### [Latest Updates](https://developer.android.com/bench/changelog)
...
[View all updates](https://developer.android.com/bench/changelog)
...
* [circle
  ...
  ![Github Image](/static/images/bench/icons/github.png)
  **Share results on the community repository**](https://github.com/android-bench/community-results)
* [circle
  ...
  ![Github Image](/static/images/bench/icons/github.png)
  **Contribute new tasks to our community dataset on GitHub**](https://github.com/android-bench/community-dataset)
...
* [circle
  ...
  ![External Image](/static/images/bench/icons/external.png)
  **Dataset available on Harbor**](https://hub.harborframework.com/datasets/android-bench/android-bench/latest)
* circle

  New models •
  Jul 8th

  ![Anthropic Image](/static/images/bench/icons/anthropic.png)
...
* circle
  ...
  ![Qwen Image](/static/images/bench/icons/qwen.png)
...
* circle
  ...
  ![Z Ai Image](/static/images/bench/icons/z-ai.png)
  **GLM 5.2**
* circle
  ...
  ![Kimi Image](/static/images/bench/icons/kimi.png)
  **Kimi K2.7 Code**
* circle
  ...
  ![Minimax Image](/static/images/bench/icons/minimax.png)
  **MiniMax M3**
* circle
...
* circle
  ...
  ![Openai Image](/static/images/bench/icons/openai.png)
...
* [circle
  ...
  ![Move Group Image](/static/images/bench/icons/move_group.png)
  **We have migrated our benchmark framework to Harbor**](http://android-developers.googleblog.com/2026/07/android-bench-llm-measurement.html)
* [circle

  New updates •
  Jul 8th

  ![News Image](/static/images/bench/icons/news.png)
  **We've updated Android Bench**](/bench/methodology)
...
* circle
  ...
  ![Gemini Image](/static/images/bench/icons/gemini.png)
  **Gemini 3.5 Flash**
* circle
...
* [circle
  ...
  ![News Image](/static/images/bench/icons/news.png)
  **See our new Archive page**](/bench/archive)
...
[Read more](https://developer.android.com/bench/methodology)

### [Android best practices](https://developer.android.com/develop)
...
[Read more](https://developer.android.com/develop)

### [Harbor dataset](https://hub.harborframework.com/datasets/android-bench/android-bench/latest)

See the full dataset on Harbor dashboard.

[View more](https://hub.harborframework.com/datasets/android-bench/android-bench/latest)
