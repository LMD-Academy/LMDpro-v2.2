...
[//]: # (source: [developer.android.com](https://developer.android.com/developer-verification))

By making Android safer, we're protecting the open environment that allows developers and
users to confidently create and connect. Android's new developer verification is an extra
layer of security that deters bad actors and makes it harder for them to repeatedly spread
harm. Starting in September 2026, apps downloaded from participating stores in select regions must be
registered by a verified developer to be installed on [certified Android devices](https://www.android.com/certified/partners/).

![Developer Identity Hero Image](https://developer.android.com/static/images/developer-verification/developer-identity-hero.png)

![Asterisk Icon](https://developer.android.com/static/images/picto-icons/asterisk.svg)

## To get verified, you'll need to complete two main steps

![Video Chat 2 Icon](https://developer.android.com/static/images/cluster-illustrations/video-chat-2.svg)

Step 1

### Verify your identity

* You will need to provide and verify your personal details, like your legal name,
  address, email address, and phone number.
* If you're registering as an organization, you'll also need to provide a D-U-N-S number
  and verify your organization's website.
* You may also need to upload official government ID.

![Policy Icon](https://developer.android.com/static/images/cluster-illustrations/policy.svg)

Step 2

### Register your package names

* Prove ownership of your apps by providing the APK signed with your private key to
  connect the APK with your developer account.

## What type of distribution do I need?

![Chevron Complex Icon](https://developer.android.com/static/images/picto-icons/chevron-complex.svg)
...
![Chevron Simple Icon](https://developer.android.com/static/images/picto-icons/chevron-simple.svg)
...
We're committed to keeping Android an open platform for you to learn, experiment, and build for fun. If you are a developer who doesn't distribute apps widely, we recognize that your needs may be different from commercial developers and have provided this free account for you. To maintain ecosystem security, apps can be installed on up to 20 devices that end-users have explicitly authorized.  
 [Learn more](/developer-verification/guides/limited-distribution).

![Google Play Icon](https://developer.android.com/static/images/logos/google-play.svg)
...
![Help Icon](https://developer.android.com/static/images/picto-icons/help.svg)
...
Visit the Help Centers for additional help with Android developer verification.

[Android Developer Console](https://support.google.com/android-developer-console)
...
![Advtimeline071526 Image](https://developer.android.com/static/developer-verification/assets/advtimeline071526.png)

## Latest News

[![Blogicon Image](https://developer.android.com/static/developer-verification/assets/blogicon.png)](http://android-developers.googleblog.com/2026/06/android-developer-verification.html)
...
[![Blogicon Image](https://developer.android.com/static/developer-verification/assets/blogicon.png)](https://android-developers.googleblog.com/2026/03/android-developer-verification-rolling-out-to-all-developers.html)
...
[![V3 Opt B Image](https://developer.android.com/static/images/developer-verification/v3-opt-b.png)](https://android-developers.googleblog.com/2026/03/android-developer-verification.html)
...
[![Sideloading Thumbnail2 Image](https://developer.android.com/static/images/developer-verification/sideloading-thumbnail2.png)](https://www.youtube.com/shorts/WcPElxbOeXY)

YouTube

### [Preview how users can sideload your apps](https://www.youtube.com/shorts/WcPElxbOeXY)

Watch a quick explainer on how the new advanced flow works.

[![A7Dehw Mjdc Sd Image](https://developer.android.com/static/images/developer-verification/A7DEhW-mjdc-SD.jpg)](https://www.youtube.com/watch?v=A7DEhW-mjdc)

YouTube

### [Android developer verification](https://www.youtube.com/watch?v=A7DEhW-mjdc)
