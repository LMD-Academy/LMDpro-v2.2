...
[//]: # (source: [developer.android.com](https://developer.android.com/distribute/google-play/resources/icon-design-specifications))

![Hero Image](/static/distribute/google-play/resources/icon-design-specifications/images/hero.png)
...
**Important:** Icons for watch faces have specific requirements. See WO-G4 in the
[Wear OS App quality guidelines](/docs/quality-guidelines/wear-app-quality#google-play) for full details.
...
![Dynamic Process Image](/static/distribute/google-play/resources/icon-design-specifications/images/dynamic-process.png)
...
![Full Space Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/full-space-dont.png)
...
![Full Space Do Image](/static/distribute/google-play/resources/icon-design-specifications/images/full-space-do.png)
...
![Illustration Full Bleed Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/illustration-full-bleed-dont.png)
...
![Illustration Full Bleed Do Image](/static/distribute/google-play/resources/icon-design-specifications/images/illustration-full-bleed-do.png)
...
![Ranking Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/ranking-dont.png)
...
![Deals Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/deals-dont.png)
...
![Play Program Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/play-program-dont.png)
...
![Mislead Users Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/mislead-users-dont.png)
...
![Shadows Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/shadows-dont.png)
...
![Shadows Do Image](/static/distribute/google-play/resources/icon-design-specifications/images/shadows-do.png)
...
![Corner Radius Dont Image](/static/distribute/google-play/resources/icon-design-specifications/images/corner-radius-dont.png)
...
![Corner Radius Do Image](/static/distribute/google-play/resources/icon-design-specifications/images/corner-radius-do.png)
...
![Brand Adaptation Full Bleed Image](/static/distribute/google-play/resources/icon-design-specifications/images/brand-adaptation-full-bleed.png)
...
![Brand Adaptation Background Image](/static/distribute/google-play/resources/icon-design-specifications/images/brand-adaptation-background.png)
...
![Brand Adaptation Shape Image](/static/distribute/google-play/resources/icon-design-specifications/images/brand-adaptation-shape.png)
...
![Brand Adaptation Keyline Image](/static/distribute/google-play/resources/icon-design-specifications/images/brand-adaptation-keyline.png)
...
![Legacy Mode Image](/static/distribute/google-play/resources/icon-design-specifications/images/legacy-mode.png)
