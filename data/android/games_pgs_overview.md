...
[//]: # (source: [developer.android.com](https://developer.android.com/games/pgs/overview))

The Google Play Games platform is a unified gaming ecosystem
encompassing Android, ChromeOS, and [Windows
PC](/games/playgames/overview). Developers use the Google Play Games platform to integrate
