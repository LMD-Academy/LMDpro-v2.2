# In-app updates Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [developer.android.com](https://developer.android.com/guide/playcore/in-app-updates))
...
**Note:** In-app updates are not compatible with apps that use APK expansion files
(`.obb` files).
...
![Flexible Flow Image](/static/images/app-bundle/flexible_flow.png)
...
restart.
![Immediate Flow Image](/static/images/app-bundle/immediate_flow.png)
