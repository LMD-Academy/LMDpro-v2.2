...
[//]: # (source: [developer.android.com](https://developer.android.com/reference/android/content/Intent))

Added in [API level 1](/guide/topics/manifest/uses-sdk-element#ApiLevels)
Summary:
| [Constants](#constants)
| [Inherited Constants](#inhconstants)
| [Fields](#lfields)
| [Ctors](#pubctors)
| [Methods](#pubmethods)
| [Inherited Methods](#inhmethods)

---

[Kotlin](/reference/kotlin/android/content/Intent "View this page in Kotlin")
|Java
...
|  |  |  |
| --- | --- | --- |
| Known direct subclasses [LabeledIntent](/reference/android/content/pm/LabeledIntent)  |  |  | | --- | --- | | [LabeledIntent](/reference/android/content/pm/LabeledIntent) | A special subclass of Intent that can have a custom label/icon associated with it. | |
...
[Intents and Intent Filters](/guide/topics/intents/intents-filters)
developer guide.
...
[manage package visibility](/training/basics/intents/package-visibility).
...
| `int` | `FLAG_EXCLUDE_STOPPED_PACKAGES` If set, this intent will not match any components in packages that are currently [stopped](/reference/android/content/pm/ApplicationInfo#FLAG_STOPPED). |
...
| `int` | `FLAG_INCLUDE_STOPPED_PACKAGES` If set, this intent will always match any components in packages that are currently [stopped](/reference/android/content/pm/ApplicationInfo#FLAG_STOPPED). |
...
Deprecated in
[API level
15](/guide/topics/manifest/uses-sdk-element#ApiLevels)
...
Deprecated in
[API level
16](/guide/topics/manifest/uses-sdk-element#ApiLevels)
...
See
[Tasks and Back
Stack](/guide/topics/fundamentals/tasks-and-back-stack) for more information about tasks.
...
[Tasks and Back Stack](/guide/topics/fundamentals/tasks-and-back-stack#TaskLaunchModes) for more information.
...
are currently
[stopped](/reference/android/content/pm/ApplicationInfo#FLAG_STOPPED).
...
See the
[Tasks and Back
Stack](/guide/topics/fundamentals/tasks-and-back-stack) documentation for important information on how some of these options impact
