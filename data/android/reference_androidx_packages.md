...
[//]: # (source: [developer.android.com](https://developer.android.com/reference/androidx/packages))

---

[Kotlin](/reference/kotlin/androidx/packages "View this page in Kotlin")
|Java

These are all the API packages. See all [API classes](/reference/androidx/classes).
