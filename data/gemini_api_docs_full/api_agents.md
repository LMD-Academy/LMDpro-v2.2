...
[//]: # (source: [ai.google.dev](https://ai.google.dev/api/agents))
...
* [Request body](#CreateAgent.request_body)
* [Response](#CreateAgent.response)
...
* [Path / Query parameters](#ListAgents.PATH_PARAMETERS)
* [Response](#ListAgents.response)
...
* [Path / Query parameters](#GetAgent.PATH_PARAMETERS)
* [Response](#GetAgent.response)
...
* [Path / Query parameters](#DeleteAgent.PATH_PARAMETERS)
* [Response](#DeleteAgent.response)
...
"base\_agent": "",
"system\_instruction": "...",
"base\_environment": { "type": "remote", "sources": [...] },
"tools": [ {"type": "code\_execution"} ]
}
