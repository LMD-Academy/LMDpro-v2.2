...
[//]: # (source: [ai.google.dev](https://ai.google.dev/api/file-search/file-search-stores))
...
* [Resource: FileSearchStore](#FileSearchStore)
  + [JSON representation](#FileSearchStore.SCHEMA_REPRESENTATION)
...
* [Request body](#body.request_body)
* [Response body](#body.response_body)
  + [JSON representation](#body.ListFileSearchStoresResponse.SCHEMA_REPRESENTATION)
* [Authorization scopes](#body.aspect)
...
| JSON representation |
| --- |
| ``` {   "fileSearchStores": [     {       object (FileSearchStore)     }   ],   "nextPageToken": string } ``` |
...
| JSON representation |
| --- |
| ``` {   "name": string,   "metadata": {     "@type": string,     field1: ...,     ...   },   "done": boolean,    // result   "error": {     object (Status)   },   "response": {     "@type": string,     field1: ...,     ...   }   // Union type } ``` |
...
`https://generativelanguage.googleapis.com/v1beta/{name=fileSearchStores/*/media/**}`
...
Required. The resource name of the media to download. Example: `fileSearchStores/abc-123/media/blob123` It takes the form `fileSearchStores/{filesearchstore}/media/{+media}`.
...
* [Request body](#body.request_body)
  + [JSON representation](#body.request_body.SCHEMA_REPRESENTATION)
* [Response body](#body.response_body)
  + [JSON representation](#body.CustomLongRunningOperation.SCHEMA_REPRESENTATION)
* [Authorization scopes](#body.aspect)
