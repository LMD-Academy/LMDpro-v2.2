...
[//]: # (source: [ai.google.dev](https://ai.google.dev/api/interactions-api))
...
input
[Content](#Resource:Content) or array ([Content](#Resource:Content)) or array ([Step](#Resource:Step)) or array (Turn) or string
 (required)
...
tools
array ([Tool](#Resource:Tool))
 (optional)

A list of tool declarations the model may call during interaction.

response\_format
[ResponseFormat](#Resource:ResponseFormat) or array ([ResponseFormat](#Resource:ResponseFormat))
 (optional)
...
tool\_choice
[ToolChoiceConfig](#Resource:ToolChoiceConfig) or enum (string)
 (optional)
...
environment
[EnvironmentConfig](#Resource:EnvironmentConfig) or string
 (optional)
...
* [Request body](#CreateTrigger.request_body)
* [Response](#CreateTrigger.response)
...
interaction
CreateAgentInteractionParams or CreateModelInteractionParams
 (required)
...
https://generativelanguage.googleapis.com/v1beta/triggers/{trigger\_id}/executions

Runs a trigger immediately.

* [Response](#RunTrigger.response)
...
* [Path / Query parameters](#ListTriggers.PATH_PARAMETERS)
* [Response](#ListTriggers.response)
...
https://generativelanguage.googleapis.com/v1beta/triggers/{id}

Gets details of a single trigger.

* [Response](#GetTrigger.response)
...
* [Path / Query parameters](#ListTriggerExecutions.PATH_PARAMETERS)
* [Response](#ListTriggerExecutions.response)
...
* [Request body](#UpdateTrigger.request_body)
* [Response](#UpdateTrigger.response)
...
* [Response](#DeleteTrigger.response)
...
enable\_prompt\_injection\_detection
boolean
 (optional)
...
result
array ([ImageContent](#Resource:ImageContent) or [TextContent](#Resource:TextContent)) or object or string
 (required)
...
content
array ([Content](#Resource:Content))
 (optional)
...
network
[EnvironmentNetworkEgressAllowlist](#Resource:EnvironmentNetworkEgressAllowlist) or enum (string)
 (optional)
