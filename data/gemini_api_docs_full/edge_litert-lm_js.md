# LiteRT-LM Web API Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert-lm/js))

[**Introducing Google AI Edge Portal**](https://ai.google.dev/edge/ai-edge-portal): Benchmark Edge AI at scale. [Sign-up](https://docs.google.com/forms/d/e/1FAIpQLSfTcGPycQve8TLAsfH46pBlXBZe9FrgJAClwbF7DeL1LgVn4Q/viewform) to request access during private preview.

The Web API of LiteRT-LM for **JavaScript and TypeScript** in the browser. This
is an early preview that supports text-in / text-out running in WebGPU.
...
**Try our demo:** For a more complete chat experience, [try out our demo in Chrome](https://google-ai-edge.github.io/LiteRT-LM/web_demos/chat/index.html).
