# LiteRT-LM Overview Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert-lm/overview))
...
* **Cross-Platform Support:** Run on Android, iOS, Web, Desktop, and IoT (e.g.
  Raspberry Pi).
* **Hardware Acceleration:** Get peak performance and system stability by
  leveraging GPU and NPU accelerators across diverse hardware.
* **Multi-Modality:** Build with LLMs that have vision and audio support.
* **Tool Use:** Function calling support for agentic workflows with
  constrained decoding for improved accuracy.
* **Broad Model Support:** Run Gemma, Llama, Phi-4, Qwen and more.

## What's New ([v0.14.0](https://github.com/google-ai-edge/LiteRT-LM/releases/tag/v0.14.0))
...
* **Android Support for Python and CLI**: The command-line interface and Python
  ...
  inside Termux or packaged with BeeWare. See the [CLI Guide](https://developers.google.com/edge/litert-lm/cli) and
...
* **[Google Play](https://play.google.com/store/apps/details?id=com.google.ai.edge.gallery)**:
  Use LLMs locally on supported Android devices.
* **[App Store](https://apps.apple.com/us/app/google-ai-edge-gallery/id6749645337)**:
  Experience on-device AI on your iOS device.
* **[GitHub Source](https://github.com/google-ai-edge/gallery)**: View the
  source code for the gallery app to learn how to integrate LiteRT-LM inside
  your own projects.
...
| **Python** | ✅ Stable | Rapid prototyping, development, on desktop, Android & Raspberry Pi. | [Python Guide](https://developers.google.com/edge/litert-lm/python) |
