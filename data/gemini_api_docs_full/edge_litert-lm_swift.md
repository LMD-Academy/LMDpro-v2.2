# LiteRT-LM Swift API Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert-lm/swift))
...
**Note:** If you see an error like `no such module LiteRTLM` after adding the
package:
...
7. Click **Add**.**Tip:** If your physical device's iOS version is lower than the deployment target
set in Xcode, you can change it by going to the **General** tab, and under
...
**Note:** Multi-modality requires models with multimodal support, such as
[Gemma 4](https://huggingface.co/litert-community/gemma-4-E2B-it-litert-lm).
...
**Note:** This requires models with tool support, such as
[Gemma 4](https://huggingface.co/litert-community/gemma-4-E2B-it-litert-lm).
