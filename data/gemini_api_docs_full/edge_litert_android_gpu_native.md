# GPU acceleration delegate with C/C++ API Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/android/gpu_native))
...
execution of your models using a [*delegate*](https://developers.google.com/edge/litert/performance/delegates) and one
of the following APIs:

* Interpreter API - [guide](https://developers.google.com/edge/litert/android/gpu)
...
LiteRT, including best practices and advanced techniques, see the [GPU
...
The LiteRT GPU delegate for Android in C or C++ uses the
...
If you are using LiteRT in Google Play Services [C API](https://developers.google.com/edge/litert/android/native),
you’ll need to use the Java/Kotlin API to check if a GPU delegate is available
for your device before initializing the LiteRT runtime.
