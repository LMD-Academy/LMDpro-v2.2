# LiteRT in Google Play services Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/android/play_services))
...
[Migrating from standalone LiteRT](https://developers.google.com/edge/litert/android/java#migrating) section to update an
 ...
 **Terms:** By accessing or using LiteRT in
Google Play services APIs, you agree to the [Terms of Service](#tos).
...
* Java API - [see guide](https://developers.google.com/edge/litert/android/java)
* C/C++ APIs - [see guide](https://developers.google.com/edge/litert/android/native)

**Note:** LiteRT in Google Play services uses the `play-services-tflite-java`
package, for both Java and C/C++.
...
* Support for hardware acceleration delegates is limited to the delegates
  listed in the [Hardware acceleration](https://developers.google.com/edge/litert/android/java#hardware-acceleration)
  section. No other acceleration delegates are supported.
* Experimental or deprecated LiteRT APIs, including custom ops, are
  not supported.
