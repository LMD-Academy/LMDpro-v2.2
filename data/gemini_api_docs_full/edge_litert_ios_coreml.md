# LiteRT Core ML delegate Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/ios/coreml))
...
LiteRT 2.4.0 and latest nightly releases.**Note:** Core ML delegate supports Core ML version 2 and later.
...
LiteRT 2.4.0 release, this was the only option.
...
[Metal delegate](https://developers.google.com/edge/litert/performance/gpu#ios) to get
...
* Does CoreML delegate work on iOS Simulator?
  + Yes. The library includes x86 and x86\_64 targets so it can run on
