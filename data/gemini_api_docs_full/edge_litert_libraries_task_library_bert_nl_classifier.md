# Integrate BERT natural language classifier Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/libraries/task_library/bert_nl_classifier))
...
* Bert Models created by [TensorFlow Lite Model Maker for text
  Classfication](https://developers.google.com/edge/litert/libraries/modify/text_classification).
...
[MobileBert](https://developers.google.com/edge/litert/libraries/modify/text_classification) model from Model Maker.
...
Metadata](https://developers.google.com/edge/litert/conversion/tensorflow/metadata.md).

The Metadata should meet the following requirements:

* input\_process\_units for Wordpiece/Sentencepiece Tokenizer
