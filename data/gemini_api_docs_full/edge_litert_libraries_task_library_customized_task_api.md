# Build you own Task API Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/libraries/task_library/customized_task_api))

[**Introducing Google AI Edge Portal**](https://ai.google.dev/edge/ai-edge-portal): Benchmark Edge AI at scale. [Sign-up](https://docs.google.com/forms/d/e/1FAIpQLSfTcGPycQve8TLAsfH46pBlXBZe9FrgJAClwbF7DeL1LgVn4Q/viewform) to request access during private preview.

[TensorFlow Lite Task Library](https://developers.google.com/edge/litert/libraries/task_library/overview) provides prebuilt
C++, Android, and iOS APIs on top of the same infrastructure that abstracts
...
encapsulating the TFLite runtime and the top Java/ObjC layer that
communicates with the C++ layer through JNI or wrapper.
...
[Vision and NLP tasks](https://developers.google.com/edge/litert/libraries/task_library/overview). You can build
your own APIs for other tasks using the Task API infrastructure.

![prebuilt_task_apis](/static/edge/litert/libraries/task_library/images/prebuilt_task_apis.svg)
...
All TFLite details are implemented in the C++ API. Create an API object by
...
for
[MobileBert](https://www.kaggle.com/models/tensorflow/mobilebert/tfLite/default/1).
...
![native_task_api](/static/edge/litert/libraries/task_library/images/native_task_api.svg)
...
* **Determine the API I/O** - Your API should expose similar input/output
  ...
  [template parameter](https://github.com/tensorflow/tflite-support/blob/master/tensorflow_lite_support/cc/task/core/base_task_api.h?q=%22template%20%3Cclass%20OutputType,%20class...%20InputTypes%3E%22).
  With the template parameters specified, the
  [`BaseTaskApi::Infer`](https://github.com/tensorflow/tflite-support/blob/master/tensorflow_lite_support/cc/task/core/base_task_api.h?q=%22Infer(InputTypes...%20args)%22)
...
![android_task_api](/static/edge/litert/libraries/task_library/images/android_task_api.svg)
...
* **Determine the API I/O** - This usually mirrors the native interfaces. e.g.
  ...
  ```
* **Create factory functions of the API** - This also mirrors native factory
  ...
  ```
* **Implement the JNI module for native functions** - All Java native methods
  ...
  [bert\_question\_answerer\_jni](https://github.com/tensorflow/tflite-support/blob/master/tensorflow_lite_support/java/src/native/task/text/qa/bert_question_answerer_jni.cc)
  is implemented.
...
![ios_task_api](/static/edge/litert/libraries/task_library/images/ios_task_api.svg)
