# Understand the C++ library Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/microcontrollers/library))

[**Introducing Google AI Edge Portal**](https://ai.google.dev/edge/ai-edge-portal): Benchmark Edge AI at scale. [Sign-up](https://docs.google.com/forms/d/e/1FAIpQLSfTcGPycQve8TLAsfH46pBlXBZe9FrgJAClwbF7DeL1LgVn4Q/viewform) to request access during private preview.

The LiteRT for Microcontrollers C++ library is part of the
...
and compatible with regular LiteRT.
...
The most important files for using the LiteRT for Microcontrollers
...
See [Get started with microcontrollers](https://developers.google.com/edge/litert/microcontrollers/get_started) for a
...
LiteRT for Microcontrollers is able to generate standalone projects
...
Guidance on porting LiteRT for Microcontrollers to new platforms and
