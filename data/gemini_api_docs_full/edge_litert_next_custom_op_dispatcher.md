# LiteRT Custom Op Dispatcher API Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/litert/next/custom_op_dispatcher))
...
* **[runtime/custom\_op\_dispatcher.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/runtime/custom_op_dispatcher.h)**:
  Main dispatcher class header

* **[runtime/custom\_op\_dispatcher.cc](https://github.com/google-ai-edge/LiteRT/tree/main/litert/runtime/custom_op_dispatcher.cc)**:
  Implementation bridging LiteRT to TFLite

### API Headers

* **[c/litert\_custom\_op\_kernel.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/c/litert_custom_op_kernel.h)**: C
  API for custom op kernel interface

* **[cc/litert\_custom\_op\_kernel.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/cc/litert_custom_op_kernel.h)**:
  C++ wrapper providing object-oriented interface

### Options System

* **[core/options.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/core/options.h)**: Core options structure with
  `CustomOpOption`

* **[c/litert\_options.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/c/options.h)**: C API for managing
  compilation options

* **[cc/litert\_options.h](https://github.com/google-ai-edge/LiteRT/tree/main/litert/cc/options.h)**: C++ wrapper for options
  management

### Test Examples

* **[cc/litert\_custom\_op\_test.cc](https://github.com/google-ai-edge/LiteRT/tree/main/litert/cc/litert_custom_op_test.cc)**: C++
  API usage example

* **[c/litert\_custom\_op\_test.cc](https://github.com/google-ai-edge/LiteRT/tree/main/litert/c/litert_custom_op_test.cc)**: C API
  usage example
