# Setup guide for Python Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/mediapipe/solutions/setup_python))
...
**Note:** If you are testing or experimenting with MediaPipe tasks, consider using
[Colaboratory](https://colab.research.google.com/), a Python notebook
environment that requires no setup and runs entirely in the cloud.
