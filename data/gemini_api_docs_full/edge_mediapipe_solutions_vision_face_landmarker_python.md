# Face landmark detection guide for Python Stay organized with collections Save and categorize content based on your preferences.

[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/mediapipe/solutions/vision/face_landmarker/python))
...
**Note:** If you use the video mode or live stream mode, Face Landmarker uses tracking
to avoid triggering the model on every frame, which helps reduce latency.
