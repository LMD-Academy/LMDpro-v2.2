...
[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/mediapipe/solutions/vision/gesture_recognizer))

[**Introducing Google AI Edge Portal**](https://ai.google.dev/edge/ai-edge-portal): Benchmark Edge AI at scale. [Sign-up](https://docs.google.com/forms/d/e/1FAIpQLSfTcGPycQve8TLAsfH46pBlXBZe9FrgJAClwbF7DeL1LgVn4Q/viewform) to request access during private preview.

![A hand making a thumbs up motion that is identified as being a thumbs up
gesture by the model with a 63% confidence
rating](/static/mediapipe/images/solutions/examples/hand_gesture.png)
...
[Try it!arrow\_forward](https://google-ai-edge.github.io/mediapipe-samples-web/#/vision/gesture_recognizer)
...
* **Android** - [Code
  example](https://github.com/google-ai-edge/mediapipe-samples/tree/main/examples/gesture_recognizer/android)
  + [Guide](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/android)
* **Python** - [Code
  example](https://colab.research.google.com/github/googlesamples/mediapipe/blob/main/examples/gesture_recognizer/python/gesture_recognizer.ipynb)
  + [Guide](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/python)
* **Web** - [Code example](https://github.com/google-ai-edge/mediapipe-samples-web/blob/main/src/tasks/gesture-recognizer.ts -
  [Guide](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/web_js)

**Note:** If you are interested in creating a custom gesture recognizer using your
own dataset, refer to the [Gesture Recognizer customization](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/customize)
tutorial.
...
| --- | --- |
| The Gesture Recognizer accepts an input of one of the following data types:   * Still images  * Decoded video frames  * Live video feed | The Gesture Recognizer outputs the following results:   * Categories of hand gestures  * Handedness of detected hands  * Landmarks of detected hands in image coordinates  * Landmarks of detected hands in world coordinates |
...
the [Customize models for Gesture Recognizer](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/customize) page.
...
![Codes for specific hand landmark points](/static/mediapipe/images/solutions/hand-landmarks.png)
...
**Note:** If your app only requires hand landmark detection, use the [Hand
landmarker](https://developers.google.com/edge/mediapipe/solutions/vision/hand_landmarker/index) task.
...
card](https://storage.googleapis.com/mediapipe-assets/gesture_recognizer/model_card_hand_gesture_classification_with_faireness_2022.pdf).
...
following [Custom models](#custom_models) section.
...
models for Gesture Recognizer](https://developers.google.com/edge/mediapipe/solutions/vision/gesture_recognizer/customize).
