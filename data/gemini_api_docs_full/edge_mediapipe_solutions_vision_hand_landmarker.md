...
[//]: # (source: [ai.google.dev](https://ai.google.dev/edge/mediapipe/solutions/vision/hand_landmarker))
...
structure](/static/mediapipe/images/solutions/examples/hand_landmark.png)
...
[Try it!arrow\_forward](https://google-ai-edge.github.io/mediapipe-samples-web/#/vision/hand_landmarker)
...
* **Web** - [Code example](https://github.com/google-ai-edge/mediapipe-samples-web/blob/main/src/tasks/hand-landmarker.ts) -
...
![Hand Landmarks Image](/static/mediapipe/images/solutions/hand-landmarks.png)
