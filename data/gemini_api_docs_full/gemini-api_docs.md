...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs))
...
Frontier-class performance rivaling larger models at a fraction of the cost.](/gemini-api/docs/models/gemini-3.6-flash)
[spark
Gemini 3.5 Flash-Lite
New

High-volume, cost-sensitive model optimized for low-latency high throughput subagent tasks.](/gemini-api/docs/models/gemini-3.5-flash-lite)
[spark
Gemini 3 Flash
