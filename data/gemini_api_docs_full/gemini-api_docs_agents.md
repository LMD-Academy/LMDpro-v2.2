...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/agents))
...
* **[Antigravity agent](/gemini-api/docs/antigravity-agent)**: General-purpose
  managed agent powered by Gemini 3.6 Flash. Runs code, manages files, and
  searches the web inside a secure Linux sandbox hosted by Google. You can
  configure the underlying model (such as Gemini 3.6 Flash, Gemini 3.5 Flash, or Gemini 3.5 Flash-Lite)
  using `agent_config`, and extend it with your own instructions, skills, and data to
  [build a custom agent](/gemini-api/docs/custom-agents).
* **[Deep Research](/gemini-api/docs/deep-research)**: Autonomous research agent
...
[Network Allow List](/gemini-api/docs/aistudio-agents#network_allow_list) (AI
Studio) or [Network rules](/gemini-api/docs/custom-agents#with_network_rules)
(API).
...
[Credentials](/gemini-api/docs/agent-environment#credentials).
...
Managed agents use a [pay-as-you-go model](/gemini-api/docs/pricing#pricing-for-agents)
...
compute is **not billed** during the preview. See [estimated costs](/gemini-api/docs/antigravity-agent#availability-and-pricing)
...
| **Pre-installed Software** | Ubuntu-based environment with Python 3.12 and Node.js 22. For more information on the environment's base image, see [Pre-installed software](/gemini-api/docs/agent-environment#pre-installed-software). |
...
* [**LangChain / LangGraph**](/gemini-api/docs/langgraph-example): Build
  stateful, complex application flows and multi-agent systems using graph
  structures.
* [**LlamaIndex**](/gemini-api/docs/llama-index): Connect Gemini agents to
  your private data for RAG-enhanced workflows.
* [**CrewAI**](/gemini-api/docs/crewai-example): Orchestrate collaborative,
  role-playing autonomous AI agents.
* [**Vercel AI SDK**](/gemini-api/docs/vercel-ai-sdk-example): Build
...
* [**Google ADK**](https://google.github.io/adk-docs/get-started/python/): An
  ...
  agents.
* [**Antigravity SDK**](https://antigravity.google/product/antigravity-sdk): Build
