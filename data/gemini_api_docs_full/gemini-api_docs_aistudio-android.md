...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/aistudio-android))
...
4. The agent generates the project and launches it in the browser-based
   Android emulator.
...
4. AI Studio signs the APK, creates the app listing (or uploads a new version),
