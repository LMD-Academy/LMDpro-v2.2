...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/deprecations))
...
This page lists the known deprecation schedules for [stable (GA)](/gemini-api/docs/models#stable) and [preview](/gemini-api/docs/models#preview)
...
[Release notes](/gemini-api/docs/changelog) page, and the announced earliest
...
dates* on which a model might be retired**. We will communicate the exact
