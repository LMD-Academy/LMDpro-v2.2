...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/document-processing))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/document-processing).
...
[Files API](/gemini-api/docs/document-processing#large-pdfs)
...
[Media resolution](/gemini-api/docs/interactions/media-resolution) guide.
