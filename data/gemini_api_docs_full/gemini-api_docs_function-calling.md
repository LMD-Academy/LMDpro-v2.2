...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/function-calling?example=meeting))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/function-calling).
...
Gemini 3 series models use an internal ["thinking"](/gemini-api/docs/thinking) process that improves function calling. The SDKs automatically handle [thought signatures](/gemini-api/docs/thought-signatures) for you.
...
[structured output](/gemini-api/docs/structured-output) for
...
* Only a [subset of the OpenAPI schema](/api/rest/v1beta/cachedContents#FunctionDeclaration) is supported.
