...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/gemini-3))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/gemini-3).
...
For detailed information, see the [Thought Signatures](/gemini-api/docs/thinking) page.`
...
7. **Which tools are supported in Gemini 3?** Gemini 3 supports
   ...
   [URL Context](/gemini-api/docs/url-context). It also supports
   standard [Function Calling](/gemini-api/docs/function-calling) for
   your own custom tools, and in
   [combination with built-in tools](/gemini-api/docs/tool-combination).
