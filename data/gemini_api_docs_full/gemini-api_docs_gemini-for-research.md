...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/gemini-for-research))
...
* **Long-context capabilities**: Gemini 3.0 Flash and Pro come with a 1-million-token
  context window. [Learn more](/gemini-api/docs/long-context).
* **Grow with Google**: Quickly access Gemini models through the API and Google AI
  ...
  platform, Gemini Enterprise Agent Platform can provide additional supporting infrastructure.
...
![Diyi Yang Image](/static/site-assets/images/diyi-yang.png)
...
[Diyi Yang's Website](https://cs.stanford.edu/~diyiy/)

![Lerrel Pinto Image](/static/site-assets/images/lerrel-pinto.png)
