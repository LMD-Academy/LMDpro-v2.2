...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/document-processing))
...
[Media resolution](/gemini-api/docs/generate-content/media-resolution) guide.
