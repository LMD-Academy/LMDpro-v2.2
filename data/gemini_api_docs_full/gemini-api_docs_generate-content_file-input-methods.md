...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/file-input-methods))
...
* For information on including files in your prompts, see the
  ...
  [Audio](/gemini-api/docs/audio), and
...
* For more guidance on prompt design, like tuning sampling parameters, see the
  [Prompt strategies](/gemini-api/docs/prompt-strategies) guide.
