...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/file-search))
...
This example shows how to directly upload a file to the [file search store](/api/file-search/file-search-stores#method:-media.uploadtofilesearchstore):
...
Check the API reference for [`uploadToFileSearchStore`](/api/file-search/file-search-stores#method:-media.uploadtofilesearchstore) for more information.

## Importing files

Alternatively, you can upload an existing file and [import it to your file search store](/api/file-search/file-search-stores#method:-filesearchstores.importfile):
...
Check the API reference for [`importFile`](/api/file-search/file-search-stores#method:-filesearchstores.importfile) for more information.
...
[`chunking_config`](/api/file-search/file-search-stores#request-body_5) setting
...
[embeddings](/gemini-api/docs/embeddings), which capture the semantic meaning of
...
![The indexing and querying process of File Search](/static/gemini-api/docs/images/File-search.png)

The indexing and querying process of File Search

In this diagram, the dotted line from *Documents* to *Embedding model*
(using [`gemini-embedding-001`](/gemini-api/docs/embeddings))
represents the `uploadToFileSearchStore` API (bypassing *File storage*).
Otherwise, using the [Files API](/gemini-api/docs/files) to separately create
...
[File Search Documents](/api/file-search/documents) API to `list` each document
...
| Model | File Search |
| --- | --- |
| [Gemini 3.6 Flash](/gemini-api/docs/models/gemini-3.6-flash) | ✔️ |
| [Gemini 3.5 Flash-Lite](/gemini-api/docs/models/gemini-3.5-flash-lite) | ✔️ |
| [Gemini 3.5 Flash](/gemini-api/docs/models/gemini-3.5-flash) | ✔️ |
| [Gemini 3.1 Pro Preview](/gemini-api/docs/gemini-3.1-pro-preview) | ✔️ |
| [Gemini 3.1 Flash-Lite](/gemini-api/docs/models/gemini-3.1-flash-lite) | ✔️ |
| [Gemini 3 Flash Preview](/gemini-api/docs/models/gemini-3-flash-preview) | ✔️ |
| [Gemini 2.5 Pro](/gemini-api/docs/models/gemini-2.5-pro) | ✔️ |
| [Gemini 2.5 Flash-Lite](/gemini-api/docs/models/gemini-2.5-flash-lite) | ✔️ |
...
* **Tool incompatibility:** File Search cannot be combined with other tools
  like [Grounding with Google Search](/gemini-api/docs/google-search),
  [URL Context](/gemini-api/docs/url-context), etc. at this time.
...
* You are charged for embeddings at indexing time based on existing
  [embeddings pricing](/gemini-api/docs/pricing#gemini-embedding-2).
* Storage is free of charge.
* Query time embeddings are free of charge.
* Retrieved document tokens are charged as regular
  [context tokens](/gemini-api/docs/tokens).

## What's next

* Visit the API reference for [File Search Stores](/api/file-search/file-search-stores) and File Search [Documents](/api/file-search/documents).
