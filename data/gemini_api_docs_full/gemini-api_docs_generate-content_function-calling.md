...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/function-calling))
...
**If you're using the [Google GenAI SDKs](/gemini-api/docs/libraries) (our
...
* Always send the `thought_signature` back to the model inside its original
  [`Part`](/api#request-body-structure).
...
**Preview:** Combining built-in tools with function calling and tool context
circulation features are in Preview in Gemini 3 models.
...
**Note:** This feature is available for [Gemini 3](/gemini-api/docs/gemini-3) series
models.
...
**Note:** Python supports automatic tool calling by passing in the
`ClientSession` into the `tools` parameters. If you want to disable it, you
can provide `automatic_function_calling` with disabled `True`.
...
**Note:** JavaScript supports automatic tool calling by wrapping the `client`
with `mcpToTool`. If you want to disable it, you can provide
`automaticFunctionCalling` with disabled `true`.
...
| --- | --- | --- | --- |
| [Gemini 3.6 Flash](/gemini-api/docs/models/gemini-3.6-flash) | ✔️ | ✔️ | ✔️ |
| [Gemini 3.5 Flash-Lite](/gemini-api/docs/models/gemini-3.5-flash-lite) | ✔️ | ✔️ | ✔️ |
| [Gemini 3.1 Pro Preview](/gemini-api/docs/models/gemini-3.1-pro-preview) | ✔️ | ✔️ | ✔️ |
| [Gemini 3.1 Flash-Lite](/gemini-api/docs/models/gemini-3.1-flash-lite) | ✔️ | ✔️ | ✔️ |
| [Gemini 3.5 Flash](/gemini-api/docs/models/gemini-3.5-flash) | ✔️ | ✔️ | ✔️ |
| [Gemini 2.5 Pro](/gemini-api/docs/models/gemini-2.5-pro) | ✔️ | ✔️ | ✔️ |
| [Gemini 2.5 Flash](/gemini-api/docs/models/gemini-2.5-flash) | ✔️ | ✔️ | ✔️ |
| [Gemini 2.5 Flash-Lite](/gemini-api/docs/models/gemini-2.5-flash-lite) | ✔️ | ✔️ | ✔️ |
...
* **Prompt Engineering:**
  ...
  + Encourage clarification: Instruct the model to ask clarifying questions
    if needed.
  + See [Agentic workflows](/gemini-api/docs/prompting-strategies#agentic-workflows)
    for further strategies on designing these prompts. Here is an example of a tested
    [system instruction](/gemini-api/docs/prompting-strategies#agentic-si-template).
...
* **Check Finish Reason:** Always check the [`finishReason`](/api/generate-content#FinishReason)
...
* Positioning of function call parts: When using custom function declarations
  [alongside built-in tools](/gemini-api/docs/tool-combination) (like Google
...
* Only a [subset of the OpenAPI
  schema](/api/caching#FunctionDeclaration) is supported.
