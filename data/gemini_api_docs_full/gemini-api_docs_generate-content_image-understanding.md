...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/image-understanding))
...
**enhanced accuracy** for specific use cases like [object detection](#object-detection), through additional
training.
