...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/media-resolution))
...
includes both global and [per-part settings](/gemini-api/docs/media-resolution#per-part-media-resolution), the per-part setting takes precedence for that specific item.
...
* `MEDIA_RESOLUTION_ULTRA_HIGH` (Per part only): Highest token count, required for specific
  use cases such as [computer use](/gemini-api/docs/computer-use).
...
* Learn more about the multimodal capabilities of Gemini API in the
  [image understanding](/gemini-api/docs/generate-content/image-understanding), [video understanding](/gemini-api/docs/generate-content/video-understanding) and
  [document understanding](/gemini-api/docs/generate-content/document-processing) guides.
