...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/priority-inference))
...
Priority inference is available to [Tier 2 & Tier 3](/gemini-api/docs/billing#about-billing) users across the GenerateContent API
...
* **Low friction**: Uses the same synchronous `generateContent` method as the
...
| [Gemini 3 Pro Image Preview](/gemini-api/docs/models/gemini-3-pro-image-preview) | ✔️ |
| [Gemini 2.5 Pro](/gemini-api/docs/models/gemini-2.5-pro) | ✔️ |
| [Gemini 2.5 Flash](/gemini-api/docs/models/gemini-2.5-flash) | ✔️ |
| [Gemini 2.5 Flash Image](/gemini-api/docs/models/gemini-2.5-flash-image) | ✔️ |
| [Gemini 2.5 Flash-Lite](/gemini-api/docs/models/gemini-2.5-flash-lite) | ✔️ |

## What's next

Read about Gemini's other [inference and optimization](/gemini-api/docs/optimization) options:

* [Flex inference](/gemini-api/docs/flex-inference) for 50% cost reduction.
* [Batch API](/gemini-api/docs/batch-api) for asynchronous processing within 24 hours.
* [Context caching](/gemini-api/docs/caching) for reduced input token costs.
