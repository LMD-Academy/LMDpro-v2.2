...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/structured-output))
...
`gemini-3.1-pro-preview` and `gemini-3.6-flash`.
