...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/generate-content/url-context))
...
[Grounding with Google Search](/gemini-api/docs/grounding) are enabled,
...
[`UrlContextMetadata` API reference](/api/generate-content#UrlContextMetadata).
...
tools usage in the [`usage_metadata`](/api/generate-content#UsageMetadata)
...
[pricing](/gemini-api/docs/pricing) page for details.
...
| [Gemini 3.1 Pro Preview](/gemini-api/docs/generate-content/gemini-3.1-pro-preview) | ✔️ |
...
* Paywalled content
* YouTube videos (See
  [video understanding](/gemini-api/docs/video-understanding#youtube) to learn
