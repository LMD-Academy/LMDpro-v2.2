...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/get-started))
...
page](/gemini-api/docs/generate-content/get-started).

This guide gets you started with the Gemini API using the [Interactions API](/gemini-api/docs/interactions-overview). You'll make your first API call in under a minute and explore text generation, multimodal understanding, image generation, structured output, tools, function calling, agents, and background execution.
...
For a detailed look at handling streaming events and delta types, see the [streaming interactions guide](/gemini-api/docs/streaming).
...
The second interaction returns a complete response object that includes only the new steps, but is grounded in the previous turn's context. Learn more about maintaining state in the [multi-turn conversations guide](/gemini-api/docs/text-generation#multi-turn-conversations), or explore [stateless mode](/gemini-api/docs/text-generation#stateless-conversations) for client-side history management.
...
Explore how to pass images, video, and audio files in the [image understanding guide](/gemini-api/docs/image-understanding).

[hearing

Audio understanding

Transcribe, summarize, or answer questions about audio files.](/gemini-api/docs/audio)
[videocam

Video understanding

Analyze video content, locate events, and describe actions.](/gemini-api/docs/video-understanding)
[description

Document processing

Extract information from PDFs and other document formats.](/gemini-api/docs/document-processing)

## 6. Multimodal generation

Gemini can generate images natively using the [Nano Banana](/gemini-api/docs/image-generation) image models.
...
When the model generates an image, it returns the base64-encoded image data in a step within the `steps` array, as well as via the `output_image` convenience property. Check out the [image generation guide](/gemini-api/docs/image-generation) to learn about aspect ratios, image editing, and references.

[record\_voice\_over

Speech generation

Generate expressive, multi-speaker speech with Gemini 3.1 Flash TTS.](/gemini-api/docs/speech-generation)
[music\_note

Music generation

Create clips and full-length songs with Lyria 3.](/gemini-api/docs/music-generation)
...
The output text block contains a valid JSON string conforming exactly to the requested schema. To learn how to define more complex structures and recursive schemas, see the [structured output guide](/gemini-api/docs/structured-output).
...
You can learn how to extract search citations in the [Google Search grounding guide](/gemini-api/docs/google-search), or see how to combine multiple tools in the [tool combination guide](/gemini-api/docs/tool-combination).

[code

Code execution

Run Python code in a secure sandboxed Borg environment.](/gemini-api/docs/code-execution)
[link

URL context

Pass public web URLs directly to ground responses in webpage content.](/gemini-api/docs/url-context)
[search

File search

Index and search across uploaded documents and media files.](/gemini-api/docs/file-search)
[map

Google Maps

Ground responses in real-world geospatial and location data.](/gemini-api/docs/maps-grounding)
[computer

Computer use

Browser automation and screen interaction.](/gemini-api/docs/computer-use)
...
For advanced features like parallel function calling or function choice modes, see the [function calling guide](/gemini-api/docs/function-calling).
...
You can also define and save [custom agents](/gemini-api/docs/custom-agents) with your own instructions, skills, and data sources.

[rocket\_launch

Quickstart

Make your first agent call, stream responses, and build a custom agent.](/gemini-api/docs/managed-agents-quickstart)
[smart\_toy

Antigravity Agent

Capabilities, tools, multimodal input, and pricing for the default agent.](/gemini-api/docs/antigravity-agent)
[experiment

Agents in AI Studio

Visual playground for prototyping agents without writing code.](/gemini-api/docs/aistudio-agents)

## 11. Run tasks in the background

Set `background=True` to run long tasks asynchronously. Poll for results with `interactions.get()`. For more details, see the [Background execution guide](/gemini-api/docs/background-execution).
...
Read about running models and agents asynchronously in the [background execution guide](/gemini-api/docs/background-execution).

## What's next

* [Background execution](/gemini-api/docs/background-execution): Run long-running tasks asynchronously and manage state.
* [Text generation](/gemini-api/docs/text-generation): System instructions, generation config, and advanced text patterns.
* [Image generation](/gemini-api/docs/image-generation): Aspect ratios, image editing, and style references.
* [Image understanding](/gemini-api/docs/image-understanding): Classification, object detection, and visual Q&A.
* [Thinking](/gemini-api/docs/thinking): Use chain-of-thought reasoning for complex tasks.
* [Function calling](/gemini-api/docs/function-calling): Parallel, compositional, and constrained function modes.
* [Google Search](/gemini-api/docs/google-search): Grounding, citations, and search suggestions.
* [Managed Agents](/gemini-api/docs/managed-agents-quickstart): Pre-built agents with code execution and file management.
* [Deep Research](/gemini-api/docs/deep-research): Autonomous multi-step research with planning and synthesis.
* [Structured output](/gemini-api/docs/structured-output): JSON schemas, enums, and recursive type definitions.
