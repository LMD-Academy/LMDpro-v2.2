...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/google-search))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/google-search).
...
* `google_search_result` : Contains `search_suggestions`, an HTML snippet
  ...
  detailed in the [Terms of Service](/gemini-api/terms#grounding-with-google-search).
...
context tool](/gemini-api/docs/url-context) to ground responses in
...
[URL context](/gemini-api/docs/url-context) to power more complex
use cases.
