...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/langgraph-example))
...
**Note:** Since having a list of messages in the state is common, there exists a
prebuilt state called `MessagesState` that you can use as a base class. For this
example the messages will be listed explicitly.
