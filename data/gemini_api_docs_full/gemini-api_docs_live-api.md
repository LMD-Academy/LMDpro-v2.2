...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/live-api))
...
[Clone example apps from GitHubcode](https://github.com/google-gemini/gemini-live-api-examples)
...
### [GenAI SDK tutorial](/gemini-api/docs/live-api/get-started-sdk)

Connect to the Gemini Live API using the GenAI SDK to build a real-time multimodal application with a Python backend.

Client-to-server

### [WebSocket tutorial](/gemini-api/docs/live-api/get-started-websocket)
...
Build real-time conversational AI applications with Agora.](https://docs.agora.io/en/conversational-ai/models/mllm/gemini)
[Firebase AI SDK
