...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens))
...
remember, it only works for the live API, and only with the `v1beta` version of
the API).
