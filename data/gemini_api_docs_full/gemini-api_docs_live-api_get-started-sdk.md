...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/live-api/get-started-sdk))
...
[Clone the example app from GitHubcode](https://github.com/google-gemini/gemini-live-api-examples/tree/main/gemini-live-genai-python-sdk)
...
* Read the [Ephemeral tokens](/gemini-api/docs/ephemeral-tokens) guide for secure authentication in [client-to-server](/gemini-api/docs/live-api#implementation-approach) applications.
