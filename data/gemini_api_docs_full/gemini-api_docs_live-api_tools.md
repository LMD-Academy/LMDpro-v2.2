...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/live-api/tools))
...
You can define tools such as [Function calling](/gemini-api/docs/function-calling)
...
| **Function calling** | Supported (synchronous only) | Supported (synchronous and [asynchronous](#async-function-calling)) |
...
See the [Function calling tutorial](/gemini-api/docs/function-calling) to learn
more.
...
environment, generating subsequent [BidiGenerateContentToolCall](/api/live#bidigeneratecontenttoolcall) messages.
...
hallucinations. See the [Grounding tutorial](/gemini-api/docs/grounding) to
learn more.
...
* Get the full story on features and configurations from the
  [Live API Capabilities guide](/gemini-api/docs/live-guide).
