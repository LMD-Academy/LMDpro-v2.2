...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/logs-datasets))
...
4. To observe project logs for the Generate Content API, first enable this in the [settings panel](#configure-logging).
