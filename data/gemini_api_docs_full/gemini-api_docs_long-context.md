...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/long-context))
...
inputs](/gemini-api/docs/vision) will work without any changes with long context.
...
[Models](/gemini-api/docs/models) page.
