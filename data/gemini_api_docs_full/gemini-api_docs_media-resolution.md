...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/media-resolution))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/media-resolution).
...
* `ultra_high` (Per content item only): Highest token count, required for specific use cases such as [computer use](/gemini-api/docs/computer-use).
