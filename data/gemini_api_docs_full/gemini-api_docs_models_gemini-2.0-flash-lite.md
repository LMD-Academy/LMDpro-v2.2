...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/models/gemini-2.0-flash-lite))
...
**Warning:** Gemini 2.0 Flash-Lite is [deprecated](/gemini-api/docs/deprecations) and has been shut down June 1, 2026. Migrate to [Gemini 3.1 Flash-Lite](/gemini-api/docs/models/gemini-3.1-flash-lite) to avoid service disruption.
...
| 123Versions | Read the [model version patterns](/gemini-api/docs/models/gemini#model-versions) for more details.  * *Shut down*: `gemini-2.0-flash-lite` * *Shut down*: `gemini-2.0-flash-lite-001` |
