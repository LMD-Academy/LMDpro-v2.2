...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-flash-native-audio-preview-12-2025))
...
Visit the [Live API](/gemini-api/docs/live) guide for full coverage
...
| token\_autoToken limits[[\*]](/gemini-api/docs/tokens) | **Input token limit**  131,072  **Output token limit**  8,192 |
...
| 123Versions | Read the [model version patterns](/gemini-api/docs/models/gemini#model-versions) for more details.  * Preview: `gemini-2.5-flash-native-audio-preview-12-2025` |
