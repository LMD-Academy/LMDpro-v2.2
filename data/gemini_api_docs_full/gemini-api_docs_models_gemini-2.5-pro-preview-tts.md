...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/models/gemini-2.5-pro-preview-tts))
...
Our premium engine for studio-quality speech synthesis, offering high-fidelity
and sophisticated audio generation. Gemini 2.5 Pro TTS is best for long-form
content, professional narrations, and complex creative workflows that require
the highest level of vocal clarity and natural prosody.

[Try in Google AI Studio](https://aistudio.google.com?model=gemini-2.5-pro-preview-tts)
