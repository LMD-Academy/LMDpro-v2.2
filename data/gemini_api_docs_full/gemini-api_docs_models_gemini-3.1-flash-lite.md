...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/models/gemini-3.1-flash-lite))
...
| --- | --- |
| id\_cardModel code | `gemini-3.1-flash-lite` |
...
| 123Versions | Read the [model version patterns](/gemini-api/docs/models/gemini#model-versions) for more details.  * `Stable: gemini-3.1-flash-lite` |
