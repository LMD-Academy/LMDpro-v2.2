...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/pricing))
...
| Output price (including thinking tokens) | Not available | $3.75 |
...
| Output price (including thinking tokens) | Free of charge | $13.50 |
...
| Context caching price | Not available | *Same as Standard*  $0.20, prompts <= 200k tokens $0.40, prompts > 200k $4.50 / 1,000,000 tokens per hour (storage price) |
| Grounding with Google Search\* | Not available | 5,000 requests per month (free, shared across Gemini 3), then $14 / 1,000 search queries |
| Grounding with Google Maps | Not available | 5,000 requests per month (free, shared across Gemini 3), then $14 / 1,000 search queries |
| Used to improve our products | [Yes](/gemini-api/terms) | [No](/gemini-api/terms) |
...
| Context caching price | Not available | *Same as Standard*  $0.05 (text / image / video)  $0.10 (audio)  $1.00 / 1,000,000 tokens per hour (storage price) |
| Grounding with Google Search\* | Not available | 5,000 requests per month (free, shared across Gemini 3), then $14 / 1,000 search queries |
| Grounding with Google Maps | Not available | 5,000 requests per month (free, shared across Gemini 3), then $14 / 1,000 search queries |
| Used to improve our products | [Yes](/gemini-api/terms) | [No](/gemini-api/terms) |
...
**Warning:** Gemini 2.0 Flash is [deprecated](/gemini-api/docs/deprecations) and has been shut down June 1, 2026. Migrate to [a newer model](/gemini-api/docs/models) to avoid service disruption.
...
| Image generation pricing | Not available ([shut down](/gemini-api/docs/deprecations#gemini-2.0-models)) | Not available ([shut down](/gemini-api/docs/deprecations#gemini-2.0-models)) |
...
**Warning:** Gemini 2.0 Flash-Lite is [deprecated](/gemini-api/docs/deprecations) and has been shut down June 1, 2026. Migrate to [a newer model](/gemini-api/docs/models) to avoid service disruption.
...
**Warning:** Imagen 4 models (`imagen-4.0-generate-001`, `imagen-4.0-ultra-generate-001`, `imagen-4.0-fast-generate-001`) are [deprecated](/gemini-api/docs/deprecations) and will be shut down on August 17, 2026; migrate to [Gemini 2.5 Flash Image](/gemini-api/docs/pricing#gemini-2.5-flash) to avoid service disruption.
...
**Note:** In some cases, an audio processing issue may prevent a video from being
generated. You will only be charged if your video is successfully generated.
...
**Warning:** Veo 3 models (`veo-3.0-generate-001`, `veo-3.0-fast-generate-001`) are [deprecated](/gemini-api/docs/deprecations) and will be shut down on June 30, 2026; migrate to [Veo 3.1 Preview](/gemini-api/docs/pricing#veo-3.1) or the GA models available through the [Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/veo/3-1-generate) to avoid service disruption.
...
**Warning:** Veo 2 (`veo-2.0-generate-001`) is [deprecated](/gemini-api/docs/deprecations) and will be shut down on June 30, 2026; migrate to [Veo 3.1 Preview](/gemini-api/docs/pricing#veo-3.1) or the GA models available through the [Gemini Enterprise Agent Platform](https://docs.cloud.google.com/gemini-enterprise-agent-platform/models/veo/3-1-generate) to avoid service disruption.
...
|  | Free Tier | Paid Tier, per 1M tokens in USD |
| --- | --- | --- |
| [Google Search](/gemini-api/docs/google-search#pricing) | 500 RPD free (limit shared for Flash and Flash-Lite). Not available for Pro. | Gemini 2.5 models:  1,500 RPD free (limit shared for Flash and Flash-Lite). Then $35 / 1,000 grounded prompts   Gemini 3 models:  5,000 prompts per month (free), then $14 / 1,000 search queries |
| [Google Maps](/gemini-api/docs/maps-grounding#pricing_and_rate_limits) | 500 RPD Not available for Pro. | 1,500 RPD free (limit shared for Flash and Flash-Lite) 10,000 RPD free for Pro. Then $25 / 1,000 grounded prompts |
...
| [URL context](/gemini-api/docs/url-context#limitations) | Free of charge | Charged as input tokens per model pricing. |
| [Computer use](/gemini-api/docs/computer-use) | Not available | Charged as regular tokens per model pricing (e.g., standard [Gemini 3.5 Flash](#gemini-3.6-flash) pricing). See the [Gemini 2.5 Computer Use Preview](#gemini-2.5-computer-use-preview-10-2025) pricing table for legacy model rates. |
| [File search](/gemini-api/docs/file-search#pricing) | Free of charge | Charged for [embeddings](#gemini-embedding) at $0.15 / 1M tokens. Retrieved document tokens charged as regular tokens per model pricing. |
| [Custom Tools endpoint (Gemini 3.1 Pro Preview)](/gemini-api/docs/models/gemini-3.1-pro-preview) | Not available | Same as [Gemini 3.1 Pro Preview](#gemini-3.1-pro-preview) pricing |
...
|  | Model | Tools |
| --- | --- | --- |
| [Gemini Deep Research Agent](/gemini-api/docs/deep-research) | All model inference is charged at standard Gemini list rates, including input, output, and intermediate input / reasoning tokens generated during agentic loops. | Tool usage fees apply per existing pricing structure, maintaining standard distinctions for Search Grounding (retrieved tokens excluded) versus Url\_context / File Search (retrieved tokens included in all other tools). |
| [Managed agents in Gemini API](/gemini-api/docs/agents) | All model inference is charged at standard Gemini list rates, including input, output, and intermediate input / reasoning tokens generated during agentic loops. (See [pricing details](/gemini-api/docs/agents#pricing)). | Environment compute (CPU, memory, sandbox execution) is not billed during the preview period. |
| [Antigravity Agent](/gemini-api/docs/antigravity-agent) | All model inference is charged at standard Gemini list rates, including input, output, and intermediate input / reasoning tokens generated during agentic loops. (See [pricing details](/gemini-api/docs/agents#pricing)). | Environment compute (CPU, memory, sandbox execution) is not billed during the preview period. |
...
* Prices may differ from the prices listed here and the prices offered on
  Gemini Enterprise Agent Platform. For Gemini Enterprise Agent Platform prices, see the [Gemini Enterprise Agent Platform pricing page](https://cloud.google.com/products/gemini-enterprise-agent-platform).
