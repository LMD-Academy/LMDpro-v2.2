...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/prompting-strategies))
...
* Prompting for image generation with [Imagen](/gemini-api/docs/imagen#imagen-prompt-guide) and [Gemini Native Image Generation](/gemini-api/docs/image-generation#prompt-guide)
* [Prompting for video generation](/gemini-api/docs/video#prompt-guide)

You can find other sample prompts in the [prompt gallery](/gemini-api/prompts)
...
[structured output](/gemini-api/docs/structured-output) feature when specifying
...
2. **Temperature:** The temperature controls the degree of randomness in token
   ...
   **Note:** The `temperature`, `top\_p`, and `top\_k` parameters control how the model
...
[Grounding with Google Search](/gemini-api/docs/google-search) connects the
Gemini model to real-time web content, and should be enabled whenever the model
may need to know obscure or recent facts.

Gemini's [code execution tool](/gemini-api/docs/code-execution) enables the
...
[Gemini 3 models](/gemini-api/docs/models#gemini-3) are designed for advanced
...
See the [Gemini thinking](/gemini-api/docs/thinking) documentation for more
detail.
...
* To learn about multimodal prompting, see
  [Prompting with media files](/gemini-api/docs/files#prompt-guide).
* To learn about image prompting, see the [Nano Banana](/gemini-api/docs/image-generation#prompt-guide)
  and [Imagen](/gemini-api/docs/imagen#imagen-prompt-guide) prompt guides.
