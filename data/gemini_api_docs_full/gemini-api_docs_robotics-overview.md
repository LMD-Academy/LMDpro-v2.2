...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/robotics-overview))
...
**Preview:** The Gemini Robotics-ER 1.6 model is currently in preview.

Gemini Robotics-ER 1.6 is a vision-language model (VLM) that brings Gemini's
...
Note that if you were using Gemini Robotics-ER 1.5, you can start using the 1.6
model by replacing the model name from `model="gemini-robotics-er-1.5-preview"`
to `model="gemini-robotics-er-1.6-preview"` in the API call.
...
through several [examples](#standard-spatial-reasoning) that highlight the model's
agentic capabilities.

If you want to jump right in, you can try out the model in Google AI Studio.

[Try in Google AI Studio](https://aistudio.google.com/prompts/new_chat?model=gemini-robotics-er-1.6-preview)

**Note:** The Gemini API does not accept requests from unrestricted API keys
and returns a `403 Forbidden` error. If you haven't already, secure your
API key by adding restrictions in
[AI Studio](https://aistudio.google.com/api-keys). For more details, see
[Secure unrestricted API keys](/gemini-api/docs/api-key#secure-unrestricted-keys).

## Safety

While Gemini Robotics-ER 1.6 was built with safety in mind, it is your
...
![An example that displays the points of objects in an image](/static/gemini-api/docs/images/robotics/point-to-object.png)

## How it works

Gemini Robotics-ER 1.6 allows your robots to contextualize and work in the
...
Gemini Robotics-ER 1.6 is also agentic, which means it can break down complex
...
Gemini Robotics-ER 1.6 has a flexible thinking budget that gives you control
...
The full runnable code as well as
...
model to find specific objects within an image and return their coordinates.
...
![An example that displays the points of objects identified in an image](/static/gemini-api/docs/images/robotics/pointing-objects.png)
...
Gemini Robotics-ER 1.6 can also analyze video frames to track objects
...
![An example that shows objects being tracked through frames in a GIF](/static/gemini-api/docs/images/robotics/object-tracking.gif)
...
![An example showing bounding boxes for objects found](/static/gemini-api/docs/images/robotics/bounding-boxes.png)

For the full runnable code, see the [Robotics
cookbook](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb).
The [Image understanding](/gemini-api/docs/image-understanding) page also has
additional examples of visual tasks like object detection and
bounding box examples.

### Trajectories

Gemini Robotics-ER 1.6 can generate sequences of points that define a
...
![An example showing the planned trajectory](/static/gemini-api/docs/images/robotics/trajectories.png)

## Agentic capabilities

The following examples demonstrate advanced **robotic reasoning** using the
model's agentic capabilities, specifically **code execution**. In these
scenarios, the model can decide to write and execute Python code to manipulate
images (such as zooming in, cropping, or rotating) to resolve ambiguities or
improve precision before answering.

### Object detection (Zoom and crop)

The following example demonstrates how to use code execution to zoom and crop an
...
![An example showing bounding boxes for objects found](/static/gemini-api/docs/images/robotics/agentic-bounding-boxes.png)
...
![An example showing a clock to read](/static/gemini-api/docs/images/robotics/agentic-clock-reading.png)
...
The following example shows how to use code execution to read a meter and
...
![An example showing a clock to read](/static/gemini-api/docs/images/robotics/agentic-fluid-container.png)

### Read markings on a circuit board

The following example demonstrates how to use code execution to read text on a
circuit board chip, allowing the model to zoom, crop, and rotate the image as needed.
...
![An example showing a clock to read](/static/gemini-api/docs/images/robotics/agentic-circuit-board.png)
...
![An example showing a clock to read](/static/gemini-api/docs/images/robotics/agentic-image-annotation.png)
...
Gemini Robotics-ER 1.6 can perform **task planning** and higher-level spatial
reasoning, inferring actions or identifying optimal locations based on
contextual understanding to orchestrate long-horizon tasks.
...
![An example that shows which object needs to be moved for another object](/static/gemini-api/docs/images/robotics/spatial-reasoning.png)
...
![An image of a lunch box and items to put into it](/static/gemini-api/docs/images/robotics/packing-lunch.png)
...
![An image of the block and bowl](/static/gemini-api/docs/images/robotics/robot-api-example.png)

Similar to the other examples on this page, the full runnable code is available
in the [Robotics cookbook](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb).
...
* **Hallucinations:** Like all large language models, Gemini Robotics-ER 1.6
...
* **Computational cost:** Running the model, especially with video inputs or
  ...
  See the [Thinking](/gemini-api/docs/thinking) page for more details.
...
| handymanCapabilities | **[Audio generation](/gemini-api/docs/speech-generation)**  Not supported  **[Caching](/gemini-api/docs/caching)**  Supported  **[Code execution](/gemini-api/docs/code-execution)**  Supported  **[Computer use](/gemini-api/docs/computer-use)**  Supported  **[File search](/gemini-api/docs/file-search)**  Supported  **[Function calling](/gemini-api/docs/function-calling)**  Supported  **[Grounding with Google Maps](/gemini-api/docs/maps-grounding)**  Supported  **[Image generation](/gemini-api/docs/image-generation)**  Not supported  **[Live API](/gemini-api/docs/live-api)**  Not supported  **[Search grounding](/gemini-api/docs/google-search)**  Supported  **[Structured outputs](/gemini-api/docs/structured-output)**  Supported  **[Thinking](/gemini-api/docs/thinking)**  Supported  **[URL context](/gemini-api/docs/url-context)**  Supported |
| speedConsumption options | **[Batch API](/gemini-api/docs/batch-api)**  Supported  **[Flex inference](/gemini-api/docs/flex-inference)**  Supported  **[Priority inference](/gemini-api/docs/priority-inference)**  Supported |
| 123Versions | Read the [model version patterns](/gemini-api/docs/models/gemini#model-versions) for more details.  * Preview: `gemini-robotics-er-1.6-preview` |
...
* Explore other capabilities and continue experimenting with different prompts
  and inputs to discover more applications for Gemini Robotics-ER 1.6.
  See the [Robotics getting started colab](https://github.com/google-gemini/robotics-samples/blob/main/Getting%20Started/gemini_robotics_er.ipynb)
  for more examples.
