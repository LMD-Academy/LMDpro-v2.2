...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/safety-guidance))
...
[safety settings](/gemini-api/docs/safety-settings) guide to learn more. It also offers Grounding
...
* **Blocking unsafe inputs and filtering output before it is shown to the
  ...
  **Note:** Automatically blocking based on a static list can have unintended
...
* **Adjusting harmful content safety settings to decrease how likely you are to
  ...
  certain types of content. Refer to the [safety settings guide](/gemini-api/docs/safety-settings) to learn about
...
* **Safety benchmarking** involves designing safety metrics that reflect the
  ...
  **Advanced tips:**
  ...
  + Beware of over-relying on “off the shelf” approaches as it's
    likely you'll need to build your own testing datasets using human
    raters to fully suit your application's context.
  + If you have more than one metric you'll need to decide how you'll
    ...
    evaluation set rather than average performance.
* **Adversarial testing** involves proactively trying to break your
  ...
  + Use [automated testing](https://www.deepmind.com/blog/red-teaming-language-models-with-language-models)
    ...
    that elicit harmful outputs from the model being tested.**Note:** LLMs are known to sometimes produce different outputs for the
