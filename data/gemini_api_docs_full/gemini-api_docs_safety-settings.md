...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/safety-settings))
...
These categories are defined in [`HarmCategory`](/api/rest/v1/HarmCategory). You
...
![Safety Settings Ui Image](/static/gemini-api/docs/images/safety_settings_ui.png)

**Note:** You are responsible for ensuring that safety settings for your intended
use case comply with the [Terms of Service](/gemini-api/terms#use-restrictions).
...
per request](#safety-filtering-per-request).
