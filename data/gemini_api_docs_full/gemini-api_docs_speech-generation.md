...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/speech-generation))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/speech-generation).
...
capabilities, as listed in the [Supported models](/gemini-api/docs/speech-generation#supported-models)
...
[Interactions overview](/gemini-api/docs/interactions-overview#convenience-properties).
...
the following format and ask it to sketch out a character for you.
...
* **Occasional text token returns:** The model occasionally returns text
  ...
  with a `500` error. Because this occurs randomly in a very small
  percentage of requests, you should implement automated retry logic in
  your application to handle these.
