...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/tokens))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/tokens).
...
Find context window sizes on the [models](/gemini-api/docs/models) page.

## What's next

* [Text generation](/gemini-api/docs/text-generation): Generation basics
* [Caching](/gemini-api/docs/caching): Reduce costs with caching
* [Pricing](/gemini-api/docs/pricing): Understand costs
