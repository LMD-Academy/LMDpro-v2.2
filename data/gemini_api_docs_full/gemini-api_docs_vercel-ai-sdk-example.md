...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/vercel-ai-sdk-example))
...
**Note:** While this guide focuses on a Node.js environment, the AI SDK is
also fully compatible with browser-based frameworks like [Next.js](https://nextjs.org/).
...
[Google Search](/gemini-api/docs/google-search) tool for Gemini. When this tool
...
![Market analysis report](/static/gemini-api/docs/images/market-research-pdf.jpg)
