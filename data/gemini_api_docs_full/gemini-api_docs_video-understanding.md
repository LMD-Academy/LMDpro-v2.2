...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/docs/video-understanding))
...
**Note:** This version of the page covers the **Interactions API**. You can use the toggle on this page to switch to the [generateContent API version of this page](/gemini-api/docs/generate-content/video-understanding).
...
* **Medial resolution**: Gemini 3 introduces granular control over multimodal
  ...
  **maximum number of tokens allocated per input image or video frame.**
  ...
  For more details on token calculations, see the [tokens](/gemini-api/docs/tokens) guide.
