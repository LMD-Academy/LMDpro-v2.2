...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemini-api/terms))
...
To use [Gemini API](/docs/gemini_api_overview),
...
an [available region](/available_regions). **You may use
...
determining the necessary and appropriate [safety settings](/gemini-api/docs/safety_setting_gemini)
...
[attribution](/api/rest/v1beta/CitationMetadata) to your
...
terms under "[How Google uses Your Data](#data-use-paid)" in
"[Paid Services](#paid-services)" apply to all Services, including Google AI
...
active [Cloud Billing account](https://cloud.google.com/billing/docs/concepts)
...
as detailed in the
"[Grounding with Google Search](#grounding-with-google-search)" section below.
...
sections of the
[Google Cloud Terms of Service](https://cloud.google.com/terms) as applicable
...
* the Pricing and Billing Terms of the Service Specific Terms at
  ...
  "Supplemental Paid Credit Terms").

"**Fees**" (as used in the
[Google Cloud Terms of Service](https://cloud.google.com/terms)) for
Paid Services are as specified on our [pricing](/pricing) page. Google may make
...
[Google Cloud Services Summary](https://cloud.google.com/terms/services)).
...
* You will not, and will not allow your end user or any third party to, copy, store,
  or implement any click tracking, Link-tracking or other monitoring of Grounded
  Results or Search Suggestions, except that:
  + You may copy and store, for up to two (2) years, the text of the Grounded Result(s): (1) that
    ...
    user.
  + You may copy and store the Grounded Result and Search Suggestions solely for
    the purpose of and for the minimum time necessary to comply with applicable
    law or regulations.
  + You may allow end user(s) to copy and store individual Grounded Results that
...
"[Unpaid Services](#unpaid-services)" and "[Paid Services](#paid-services)"),
...
separate [Google Maps End User Terms](https://maps.google.com/help/terms_maps.html)
and the [Google Privacy Policy](https://policies.google.com/privacy) govern the
...
Processor](https://business.safety.google/processorterms/).
...
[archived here](/gemini-api/terms-archive).
