...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs))

**Gemma 4** released with text, audio and image input and long up to 256K context window! [**Learn more**](/gemma/docs/core)

![Alt Gemma logo](https://ai.google.dev/gemma/images/gemma_sq.png)
...
* [**Gemma 4**](/gemma/docs/core): Solve a wide variety of generative
  AI tasks with text, audio and image input, support for over 140 languages,
  and long 128K and up to 256K context window.
* [**EmbeddingGemma**](/gemma/docs/embeddinggemma): Produce numerical
  representations of text for downstream tasks like information retrieval,
  semantic similarity search, classification, and clustering.
* [**ShieldGemma 2**](/gemma/docs/shieldgemma): Evaluate the safety of
  generative AI models' input and output against defined policies.
