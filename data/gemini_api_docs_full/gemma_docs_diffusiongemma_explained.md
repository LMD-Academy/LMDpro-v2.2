...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/diffusiongemma/explained))
...
![autoregressive versus diffusion](/static/gemma/docs/diffusiongemma/images/ar_vs_diffusion.png)
...
![DiffusionGemma overview](/static/gemma/docs/diffusiongemma/images/cond_overview-1.png)
...
![Masked Diffusion](/static/gemma/docs/diffusiongemma/images/md_forward_reverse_diffusion.png)
...
![Uniform State Diffusion](/static/gemma/docs/diffusiongemma/images/usd_forward_reverse_diffusion.png)
...
![Block Autoregressive Denoising](/static/gemma/docs/diffusiongemma/images/patch_encoder.png)
