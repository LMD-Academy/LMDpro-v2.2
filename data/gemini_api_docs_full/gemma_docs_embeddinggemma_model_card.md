...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/embeddinggemma/model_card))
...
* Additional methods: Filtering based on content quality and safety in line
  with [our policies](https://ai.google/static/documents/ai-responsibility-update-published-february-2025.pdf).
...
feedforward, and projection layers, and int8 for attention (e4\_a8\_f4\_p4).
...
| Code Retrieval | Used to retrieve a code block based on a natural language query, such as *sort an array* or *reverse a linked list*. Embeddings of the code blocks are computed using retrieval\_document. | task: code retrieval | query: {content} |
