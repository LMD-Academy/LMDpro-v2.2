...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/functiongemma/formatting-and-best-practices))
...
FunctionGemma builds on the [Gemma prompt structure](/gemma/docs/core/prompt-structure), using
...
* **Mitigation Strategies:**
  ...
  + **Fine-tuning:** For production environments where users frequently use
    ...
    we recommend [fine-tuning](/gemma/docs/functiongemma/finetuning-with-functiongemma) the model on a dataset that explicitly
...
with get\_current\_temperature and respond that it cannot provide weather
information.
...
[Full function calling sequence with FunctionGemma](/gemma/docs/functiongemma/full-function-calling-sequence-with-functiongemma)
