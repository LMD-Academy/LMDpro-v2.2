...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/functiongemma/function-calling-with-hf))

**Gemma 4** released with text, audio and image input and long up to 256K context window! [**Learn more**](/gemma/docs/core)

[View on ai.google.dev](https://ai.google.dev/gemma/docs/functiongemma/function-calling-with-hf) | [Run in Google Colab](https://colab.research.google.com/github/google-gemma/cookbook/blob/main/docs/functiongemma/function-calling-with-hf.ipynb) | [Run in Kaggle](https://kaggle.com/kernels/welcome?src=https://github.com/google-gemma/cookbook/blob/main/docs/functiongemma/function-calling-with-hf.ipynb) | [Open in Vertex AI](https://console.cloud.google.com/vertex-ai/colab/import/https%3A%2F%2Fraw.githubusercontent.com%2Fgoogle-gemma%2Fcookbook%2Fmain%2Fdocs%2Ffunctiongemma%2Ffunction-calling-with-hf.ipynb) | [View source on GitHub](https://github.com/google-gemma/cookbook/blob/main/docs/functiongemma/function-calling-with-hf.ipynb) |
...
In these cases, manually defining the JSON schema is preferred to ensure nested properties (such as theme or font\_size within a config object) are explicitly defined for the model.
