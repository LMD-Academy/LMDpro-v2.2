...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/functiongemma/model_card))
...
* **Tiny Garden:** A model fine-tuned to power a voice-controlled
  ...
  flowers in plots 1 and 2" into app-specific functions (e.g., plant\_seed,
  water\_plots) and coordinate targets. This demonstrates the model's capacity
...
* **Mobile Actions:** To empower developers to build their own expert
  ...
  [fine-tuning recipe](https://github.com/google-gemma/cookbook/blob/main/.archive/FunctionGemma/%5BFunctionGemma%5DFinetune_FunctionGemma_270M_for_Mobile_Actions_with_Hugging_Face.ipynb)
...
"Mobile Actions"
[recipe](https://github.com/google-gemma/cookbook/blob/main/.archive/FunctionGemma/%5BFunctionGemma%5DFinetune_FunctionGemma_270M_for_Mobile_Actions_with_Hugging_Face.ipynb).
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| CPU | dynamic\_int8 | 1024 | 1718 | 125.9 | 0.3 | 288 | 551 |

Tiny Garden On Device Performance

| Backend | Quantization scheme | Context length | Prefill (tokens per second) | Decode (tokens per second) | Time-to-first-token (seconds) | Model Size (MB) | Peak RSS Memory (MB) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| CPU | dynamic\_int8 | 1024 | 1743 | 125.7 | 0.3 | 288 | 549 |
