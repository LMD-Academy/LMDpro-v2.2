...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/gemma-3n))
...
* **Audio input**: Process sound data for speech recognition, translation,
  ...
  [Learn more](/gemma/docs/core/huggingface_inference#audio)
* **Visual and text input**: Multimodal capabilities let you handle vision,
  ...
  [Learn more](/gemma/docs/core/huggingface_inference#vision)
...
* **Conditional parameter loading:** Bypass loading of vision and audio
  ...
  [Learn more](#conditional-parameter)
...
**Tip:** If you are interested in building generative AI solutions for Android
mobile applications, check out Gemini Nano. For more information, see the
...
![Gemma 3n diagram of parameter usage](/static/gemma/docs/images/gemma-3n-parameters.png)
