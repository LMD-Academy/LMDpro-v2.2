...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/get_started))
...
[Responsible Generative AI Toolkit](/responsible).

[Get it on Kaggle](https://www.kaggle.com/models/google/gemma-4)
...
| **12B** | [Gemma 4 (core)](/gemma/docs/core) | Text, images, audio ➔ Text | Laptops, desktop computers and small servers |
...
| Size | Variant | Input ➔ Output | Intended Platform |
| --- | --- | --- | --- |
| **2B** | [Gemma (core)](/gemma/docs/core) [CodeGemma](/gemma/docs/codegemma) | Text ➔ Text | Mobile devices and laptops |
| **7B** | [Gemma (core)](/gemma/docs/core) [CodeGemma](/gemma/docs/codegemma) | Text ➔ Text | Desktop computers and small servers |
