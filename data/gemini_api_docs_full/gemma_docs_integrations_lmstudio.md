...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/integrations/lmstudio))

**Gemma 4** released with text, audio and image input and long up to 256K context window! [**Learn more**](/gemma/docs/core)

[LM Studio](https://lmstudio.ai) is a friendly yet powerful desktop application
...
more](https://lmstudio.ai/docs/cli/local-models/get)).
...
1. LM Studio will automatically detect the model and it will populate in the
   application under "My Models."
2. Adjust context length and hardware settings as needed.
...
structure at "[Import Models](https://lmstudio.ai/docs/app/advanced/import-model)".
...
models. See a list of commands at "[lms](https://lmstudio.ai/docs/cli)".
...
Settings](https://huggingface.co/settings/local-apps) in Hugging Face.
