...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/paligemma/prompt-system-instructions))
...
[task syntax](#prompt_task_syntax), which is described in the next section. For
...
**Important:** The [PaliGemma FT](/gemma/docs/paligemma#categories) category of
...
[Generate PaliGemma output with Keras](/gemma/docs/paligemma/inference-with-keras)
tutorial.
...
the [Gemma system instructions](/gemma/docs/core/prompt-structure#system-instructions)
