...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/shieldgemma/model_card))
...
* [ShieldGemma on Kaggle](https://www.kaggle.com/models/google/shieldgemma)
...
[Gemma 2](https://ai.google.dev/gemma#gemma-2) that target four harm categories (sexually explicit, dangerous
...
1. Preamble, establishing the model as a policy expert, based on the
   [LLM-as-a-judge](https://arxiv.org/abs/2306.05685) technique.
2. User prompt, wrapped with `<start_of_turn>` and `<end_of_turn>` control
   tokens.
3. Optionally, a model response also wrapped by `<start_of_turn>` and
...
variety of sources, see the [Gemma 2 documentation](https://ai.google.dev/gemma#gemma-2) for more details.
...
[ShieldGemma technical report](https://storage.googleapis.com/deepmind-media/gemma/shieldgemma-report.pdf).
...
the [Gemma 2 model card](https://ai.google.dev/gemma/docs/core/model_card_2).

### Software

Training was done using [JAX](https://github.com/jax-ml/jax) and [ML Pathways](https://blog.google/technology/ai/introducing-pathways-next-generation-ai-architecture/). For more
details refer to the [Gemma 2 model card](https://ai.google.dev/gemma/docs/core/model_card_2).
...
[Responsible Generative AI Toolkit](https://ai.google.dev/responsible), which is a set of
...
[Gemma 2 model card](https://ai.google.dev/gemma/docs/core/model_card_2) for more details. Additionally,
...
subject to Google's [prohibited use policies](https://ai.google.dev/gemma/prohibited_use_policy).
...
Refer to the [Gemma model card](https://ai.google.dev/gemma/docs/core/model_card_2) for more details.
