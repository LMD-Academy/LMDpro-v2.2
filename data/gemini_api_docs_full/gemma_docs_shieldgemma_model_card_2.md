...
[//]: # (source: [ai.google.dev](https://ai.google.dev/gemma/docs/shieldgemma/model_card_2))
...
[Gemma 3 model card](https://ai.google.dev/gemma/docs/core/model_card_3) for more details. Additionally,
