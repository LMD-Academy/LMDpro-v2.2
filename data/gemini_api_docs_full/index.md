...
[New
Build with Gemini 3 Flash, our frontier intelligence built for speed and scale](https://aistudio.google.com/apps)
...
![AI for every developer](/static/images/landing/gemini-landing-bg_04.png)
...
![Integrate Google AI models with an API key](/static/images/landing/gemini-start-building-code.png)

[![Integrate models into apps](/static/images/landing/gemini-start-building-card-integrate.svg)

#### Integrate models into apps

Unlock AI capabilities for your apps with a simple call to the Gemini API.

Gemini API docs](https://ai.google.dev/gemini-api/docs)
[![Explore AI models](/static/images/landing/gemini-start-building-card-explore.svg)
...
![Own your AI with Gemma open models](/static/images/landing/gemini-start-building-gemma.png)
...
![Run AI models on-device with Google AI Edge](/static/images/landing/gemini-start-building-edge.png)

[![Gemini Nano on Android](/static/images/landing/gemini-start-building-card-nano.svg)

#### Gemini Nano on Android

Unlock low latency and cost effective generative AI features while keeping data on-device.

Android docs](https://developer.android.com/ai/gemini-nano)
[![AI features for web apps](/static/images/landing/gemini-start-building-card-apps.svg)

#### AI features for web apps

Integrate AI models like Gemini Nano into web apps with Chrome's built-in web platform APIs.

AI on Chrome](https://developer.chrome.com/docs/ai/built-in)
...
![Build with AI responsibly](/static/images/landing/gemini-start-building-responsible.png)

[![Gemini Nano on Android](/static/images/landing/gemini-start-building-card-models.svg)

#### Build responsible models
...
[![Develop secure AI systems](/static/images/landing/gemini-start-building-card-security.svg)

#### Develop secure AI systems
...
![Agent Image Image](/static/images/landing/productivity/agent-image.png)

[![Partner logo for Jules](/static/images/partners/jules.svg)

Jules](http://labs.google.com/jules)
[![Partner logo for Colab](/static/images/partners/colab.svg)

Colab](https://colab.google/)
[![Partner logo for Firebase](/static/images/partners/firebase-new.svg)
...
![Analysis Image Image](/static/images/landing/productivity/analysis-image.png)

[![Partner logo for Android Studio](/static/images/partners/android-studio.svg)

Android Studio](https://developer.android.com/gemini-in-android)
[![Partner logo for Chrome Devtools](/static/images/partners/logo-chrome-devtools.svg)

Chrome DevTools](https://developer.chrome.com/docs/devtools/console/understand-messages)
[![Partner logo for Firebase](/static/images/partners/firebase-new.svg)

Firebase](https://firebase.google.com/products/generative-ai)
[![Partner logo for Google Cloud](/static/images/partners/logo-gcloud.svg)

Google Cloud](https://cloud.google.com/products/gemini/code-assist)
[![Partner logo for JetBrains IDEs](/static/images/partners/logo-intellij.svg)

JetBrains IDEs](https://plugins.jetbrains.com/plugin/8079-gemini--google-cloud-code)
[![Partner logo for Vs Code](/static/images/partners/logo-vscode.svg)
...
![Code Generation Image Image](/static/images/landing/productivity/code-generation-image.png)
...
![Code Chat Image Image](/static/images/landing/productivity/code-chat-image.png)
...
![Tldraw showcase preview](/static/images/showcase/tldraw/thumbnail.jpg)

Tldraw

Prototyping a new natural language computing experience on an infinite canvas with Gemini 2.0

[View](/showcase/tldraw)

![Rooms showcase preview](/static/images/showcase/rooms/thumbnail.jpg)
...
![Toonsutra showcase preview](/static/images/showcase/toonsutra/thumbnail.jpg)
...
[View](/showcase/toonsutra)

![Viggle showcase preview](/static/images/showcase/viggle/thumbnail.jpg)

Viggle

Experimenting with Gemini 2.0 to create virtual characters and audio narration for their AI powered video platform

[View](/showcase/viggle)

![Sublayer showcase preview](/static/images/showcase/sublayer/thumbnail.jpg)

Sublayer

See how the Ruby-based AI agent framework empowers developer teams to be more productive with the power of Gemini models.

[View](/showcase/sublayer)

![Sourcegraph showcase preview](/static/images/showcase/sourcegraph/thumbnail.jpg)

Sourcegraph

Learn how Cody AI saw big quality gains using Gemini's massive context window.

[View](/showcase/sourcegraph)

![AgentOps showcase preview](/static/images/showcase/agentops/thumbnail.jpg)
