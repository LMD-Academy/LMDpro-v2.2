--- source: https://developer.android.com/guide/playcore/feature-delivery ---
...
**Run > Run** from the menu bar (or by clicking **Run** ![](/static/studio/images/buttons/toolbar-run.png) in
the toolbar).
