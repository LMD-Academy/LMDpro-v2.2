--- source: https://developer.android.com/reference/androidx/annotation/NavigationRes ---
...
[View Source](https://cs.android.com/search?q=file:androidx/annotation/NavigationRes.jvm.kt+class:androidx.annotation.NavigationRes)

Added in [1.0.0](/jetpack/androidx/releases/annotation#1.0.0)

---

[Kotlin](/reference/kotlin/androidx/annotation/NavigationRes "View this page in Kotlin")
|Java
...
public annotation NavigationRes
```
