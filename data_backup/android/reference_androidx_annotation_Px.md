--- source: https://developer.android.com/reference/androidx/annotation/Px ---
...
[View Source](https://cs.android.com/search?q=file:androidx/annotation/Px.jvm.kt+class:androidx.annotation.Px)

Added in [1.0.0](/jetpack/androidx/releases/annotation#1.0.0)

---

[Kotlin](/reference/kotlin/androidx/annotation/Px "View this page in Kotlin")
|Java
