--- source: https://developer.android.com/reference/androidx/annotation/StyleableRes ---
...
[View Source](https://cs.android.com/search?q=file:androidx/annotation/StyleableRes.jvm.kt+class:androidx.annotation.StyleableRes)

Added in [1.0.0](/jetpack/androidx/releases/annotation#1.0.0)

---

[Kotlin](/reference/kotlin/androidx/annotation/StyleableRes "View this page in Kotlin")
|Java
...
public annotation StyleableRes
```
